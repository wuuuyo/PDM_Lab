    ...
    "items": [
      {
        ...
        "content": [
          "定义：整合财务、采购、库存、生产、销售、人力等核心业务，数据一处录入、处处可用。",
          "关键特征：",
          "企业级：服务整个公司",
          ...
          "经典 ERP 8 大模块",
          "记忆口诀：财采销存、生人客供",
          "财务 · 管什么=总账、应收应付、固定资产、报表 · 场景类比=财务系统",
          "采购 · 管什么=采购申请、订单、收货、付款 · 场景类比=物料采购",
          "销售 · 管什么=报价、订单、发货、回款 · 场景类比=代理商订单",
          "库存 · 管什么=入库、出库、盘点、调拨 · 场景类比=运营管理平台-调拨维保",
          "生产 · 管什么=BOM、工单、生产排程、车间管理 · 场景类比=机器人装配线",
          "人力 · 管什么=员工档案、考勤、薪资、绩效 · 场景类比=HR 系统",
          "CRM · 管什么=客户、商机、合同、售后 · 场景类比=代理商/客户管理",
          "供应链 · 管什么=物流、仓储、供应商 · 场景类比=物流系统",
          "轻量级 ERP 生态（自研 + SaaS）：",
          "销售 · 自研系统=代理商平台 · 状态=已落地",
          "库存 · 自研系统=运营管理平台-调拨 · 状态=已优化",
          "维保 · 自研系统=运营管理平台-维保 · 状态=已落地",
          "财务 · 自研系统=财务系统 · 状态=独立系统",
          "生产 · 自研系统=MES/装配线 · 状态=独立系统",
          "培训 · 自研系统=企学宝 · 状态=对接中",
          "CRM · 自研系统=代理商平台-CRM · 状态=已落地",
          "OA · 自研系统=飞书审批 + OA 调拨单 · 状态=已落地",
          "BI · 自研系统=数据看板 · 状态=已有雏形",
          "主流 ERP 产品：",
          ...
          "云 ERP · 产品=Workday、NetSuite · 适合=中型企业",
          "开源 · 产品=Odoo、ERPNext · 适合=中小企业",
          "行业垂直 · 产品=明源云、蓝凌 OA · 适合=单一行业"
        ],
        "section": "第二部分：业务管理",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
      ...
      },
      {
        ...
        "content": [
          "定义：管理企业与客户关系的系统和方法，覆盖线索、商机、合同与售后。",
          "常见能力：客户档案、商机漏斗、合同管理、售后跟进。"
        ],
        "cases": [
      ...
      },
      {
        ...
        "content": [
          "定义：覆盖流程审批、文档管理与协同办公的内部效率系统。",
          "常见场景：请假审批、费用报销、调拨申请、文档协作。",
          "落地示例：飞书审批 + OA 调拨单。"
        ],
        "section": "第二部分：业务管理",
        "sourceId": "industry-terms",
      ...
      },
      {
        ...
        "title": "IPD",
        "summary": "跨部门协作的产品开发方法论",
        "fullName": "Integrated Product Development",
        "fullNameZh": "集成产品开发",
        "tags": [
          "业务方法",
          "IPD"
        ...
        "content": [
          "定义：一套强调跨部门协作、异步开发与结构化流程的产品开发方法。",
          "核心要点：市场驱动、跨职能团队、阶段性评审、并行工程。"
        ],
        "cases": [
      ...
      },
      {
        ...
        "content": [
          "定义：企业内部相对独立的业务部门或利润中心，通常有独立目标和经营结果。",
          "沟通场景：跨 BU 协作时，要先对齐目标和优先级。"
        ],
        "cases": [
          "「这个需求需要协调多个 BU」"
        ],
      ...
      },
      {
        ...
        "title": "服务请求",
        "summary": "售后服务与问题处理相关缩写",
        "fullName": "SR / PR",
        "fullNameZh": "服务请求与问题报告",
        "tags": [
          "售后",
          "缩写"
        ],
        "content": [
          "SR · 全称=Service Request · 含义=客户服务请求，通常指售后问题处理",
          "PR · 全称=Problem Report / Pull Request · 含义=问题报告，或研发的代码合并请求"
        ],
        "cases": [
          "SR：「收到一个 SR，需要处理机器故障」",
