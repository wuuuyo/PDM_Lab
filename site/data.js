    ...
    "items": [
      ...
      },
      {
        ...
        "content": [
          ...
          "重要伙伴（KP）：谁帮我一起做？",
          "成本结构（C$）：我要花什么钱？",
          "一句话定义：商业模式画布 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "代理商平台\"AI 悬浮球\"的 BMC\nCS：区域代理商（核心）、客服（次要）\nVP：5 秒发起售后咨询,跨系统不用切\nCH：代理商平台首页常驻入口 + 飞书推送\nCR：自助为主 + AI 转人工兜底\nR$：不直接变现,但提活跃度带动培训订阅\nKR：LLM API + 客服知识库 + 行为数据\nKA：对话设计 + 知识库更新 + 模型调优\nKP：企学宝(内容供应)、阿里云(算力)\nC$：API 调用费(月 5-10 万) + 维护人力(1 FTE)",
          "案例：如果团队讨论“商业模式画布”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "9 格填完如果发现\"价值主张\"清晰但\"收入流\"弱,要么补变现路径,要么承认\"作为留存工具推进、不能单独立项\"。",
          "PM 记忆法：回答 商业模式画布 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 战略与定位（决定\"做对的事\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "周期 · OKR=季度 · KPI=月/季度",
          "一句话定义：OKR 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“OKR”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "OKR 帮你\"知道自己做的事为什么重要\"——把每周做的需求挂到季度 KR 上,周报/复盘里能清晰展示\"我做的 AI 悬浮球对话效果,贡献了 KR1 30% 的提升\"。",
          "PM 记忆法：回答 OKR 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 战略与定位（决定\"做对的事\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：用户画像 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“用户画像”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "做功能时\"对齐小王用起来顺不顺\"——他看不懂/嫌麻烦的功能,90% 是失败功能。",
          "PM 记忆法：回答 用户画像 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：同理心地图 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“同理心地图”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "基于这张图设计\"5 分钟考点速览\"功能,比\"AI 悬浮球加表情包\"这种自嗨功能靠谱 10 倍。",
          "3 个核心问题:用户嘴上在抱怨什么？心里真正担心什么？为了目标愿意做出什么妥协？",
          "PM 记忆法：回答 同理心地图 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "2. 用户研究（决定\"对的人\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：用户访谈 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“用户访谈”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "访谈前先列 10 个问题,但只背 3 个——剩下 7 个根据用户的回答即兴追问,才有价值。",
          "PM 记忆法：回答 用户访谈 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "2. 用户研究（决定\"对的人\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "技术成本：研发要多少人力/时间/风险？",
          "ROI：综合下来值不值？",
          "一句话定义：需求评估 4 维度 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“需求评估 4 维度”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 需求评估 4 维度 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "Effort 投入工作量：人月",
          "一句话定义：RICE 评分法 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“RICE 评分法”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "把讨论从\"谁拍脑袋\"变成\"谁有数据\"——分数高的先做。",
          "PM 记忆法：回答 RICE 评分法 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "3. 需求管理（决定\"做哪些\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "可以有,时间够就做、没时间就砍：争取做",
          "这版不做,先放 backlog：不做",
          "一句话定义：MoSCoW 优先级法 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“MoSCoW 优先级法”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "RICE + MoSCoW 配合用——先用 RICE 从 10 个候选里排\"分数前 5\",再用 MoSCoW 把前 5 个分\"M/S/C/W\"决定\"这版本做哪几个\"。",
          "PM 记忆法：回答 MoSCoW 优先级法 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "3. 需求管理（决定\"做哪些\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "成本低 → 价值高=快速做，价值低=砍掉",
          "一句话定义：优先级矩阵 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“优先级矩阵”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 优先级矩阵 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "3. 需求管理（决定\"做哪些\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "\"这个我们做 P2,先做更重要的\"（明确）",
          "一句话定义：砍需求 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“砍需求”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "砍需求的能力 = 把资源留给更重要的事的能力——PM 不砍需求,团队会被拖死。",
          "PM 记忆法：回答 砍需求 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "3. 需求管理（决定\"做哪些\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：用户故事 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“用户故事”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "每个用户故事至少配 3 条验收标准——只写\"做什么\"不写\"做到什么程度\"的 PRD,研发交付出来大概率\"够用但不是你想要的\"。",
          "PM 记忆法：回答 用户故事 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：信息架构 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“信息架构”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "IA 决定\"产品好不好用\"的 80%,再炫的视觉救不回来混乱的结构。",
          "PM 记忆法：回答 信息架构 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "4. 设计与交付（决定\"做对\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：PRD 标准 7 章节 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“PRD 标准 7 章节”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 PRD 标准 7 章节 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "4. 设计与交付（决定\"做对\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：PRD 评审 Checklist 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“PRD 评审 Checklist”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 PRD 评审 Checklist 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "4. 设计与交付（决定\"做对\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：上线 Checklist 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“上线 Checklist”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 上线 Checklist 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "4. 设计与交付（决定\"做对\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：AARRR 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“AARRR”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "每一步都有独立指标,不能只盯\"获客\"不看\"留存\"。",
          "PM 记忆法：回答 AARRR 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "用户产生数据/内容：点赞、关注、收藏",
          "一句话定义：上瘾模型 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“上瘾模型”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "做产品时反问自己\"用户为什么每天回来\"——靠\"必须用业务\"驱动 vs 靠\"想用就用\"驱动,设计策略完全不同。",
          "PM 记忆法：回答 上瘾模型 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "5. 数据与增长（决定\"做得好\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：Cohort 队列分析 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“Cohort 队列分析”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "所有\"留存问题\"先跑 Cohort 再说结论——平均数会掩盖真相。",
          "PM 记忆法：回答 Cohort 队列分析 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "5. 数据与增长（决定\"做得好\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "> 30 良好",
          "< 0 危险",
          "一句话定义：NPS 净推荐值 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“NPS 净推荐值”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "NPS 的真正价值不是数字本身,是\"贬损者的具体吐槽\"——深度追问后分类汇总,高频痛点就是下一期 P0。",
          "PM 记忆法：回答 NPS 净推荐值 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "5. 数据与增长（决定\"做得好\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "5：决策上线 — 胜出版全量、败出版回滚",
          "一句话定义：A/B 测试 5 步 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“A/B 测试 5 步”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "指标必须\"先于上线\"定义好——不然跑完数据你也不知道\"涨了\"是因为按钮位置还是别的因素。",
          "PM 记忆法：回答 A/B 测试 5 步 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "5. 数据与增长（决定\"做得好\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：增长飞轮 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "代理商平台\"代理活跃度\"飞轮\n代理活跃使用\n    ↓\n积累数据 + 改进产品\n    ↓\n产品更好用\n    ↓\n新代理主动注册\n    ↓\n代理活跃使用(循环)",
          "案例：如果团队讨论“增长飞轮”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "找到你的飞轮,把每个动作挂上去——每个新需求反问\"它推动飞轮的哪一环\"。",
          "PM 记忆法：回答 增长飞轮 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "5. 数据与增长（决定\"做得好\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：RACI 矩阵 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“RACI 矩阵”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "RACI 跑完,谁也不甩锅——研发知道自己得干、产品知道自己兜底、客服知道自己该给客户怎么答。",
          "PM 记忆法：回答 RACI 矩阵 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：鱼骨图 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“鱼骨图”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "鱼骨图的核心不是\"画得多漂亮\"而是\"团队一起画\"——研发看技术、客服看用户、运维看流程,3 视角拼出全貌。",
          "PM 记忆法：回答 鱼骨图 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "6. 协作与决策（决定\"和谁一起做\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：5Why 分析法 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“5Why 分析法”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "不 5Why 的话,可能去优化避障算法,治标不治本。",
          "PM 记忆法：回答 5Why 分析法 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "6. 协作与决策（决定\"和谁一起做\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：PDCA 戴明环 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“PDCA 戴明环”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "复盘是\"事后总结经验\",PDCA 是\"边做边改的循环\"——强调\"持续\"。",
          "PM 记忆法：回答 PDCA 戴明环 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "6. 协作与决策（决定\"和谁一起做\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：设计冲刺 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“设计冲刺”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "重要功能上线前、需求大但方向不明时跑一轮设计冲刺,哪怕压缩成 5 小时也能帮 PM ① 在动手前暴露分歧 ② 用真用户验证而不是\"领导拍板\" ③ 节省\"做完才发现方向错\"的几周返工。",
          "PM 记忆法：回答 设计冲刺 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "6. 协作与决策（决定\"和谁一起做\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "4 层结构:",
          "目标 (Goal)\n  ↓ 服务谁\n参与者 (Actor)\n  ↓ 怎么影响他们\n影响 (Impact)\n  ↓ 怎么实现\n交付物 (Deliverable)",
          "一句话定义：影响地图 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“影响地图”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "让团队对齐\"为什么做\"——避免\"做完发现不是用户要的\"。",
          "PM 记忆法：回答 影响地图 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "6. 协作与决策（决定\"和谁一起做\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "content": [
          ...
          "7. 写复盘表(NO.XXX)",
          "8. 关联需求(link 字段挂本周需求)",
          "一句话定义：复盘 8 步法 是 产品策划方法论 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“复盘 8 步法”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "8 步缺一步,复盘就会变成\"印象流\",失去\"可索引、可追溯、可复盘经验\"的价值。",
          "PM 记忆法：回答 复盘 8 步法 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "6. 协作与决策（决定\"和谁一起做\"）",
        "sourceId": "product-methodology",
        "sourceLabel": "产品策划方法论",
      ...
      },
      {
        ...
        "title": "KANO 模型",
        "summary": "KANO 模型用于把需求按满意度影响分层，帮助 PM 区分“必须做”“值得优化”和“制造惊喜”的需求。",
        "tags": [
          "产品经理八股",
          "KANO",
          "需求分类",
        ...
        "content": [
          "KANO 模型把需求分为基本型、期望型、兴奋型、无差异型和反向型，用来判断不同需求对用户满意度的影响。它解决的问题不是“要不要做功能”，而是“这个功能做到什么程度才值得”。",
          "基本型需求：用户默认你必须具备，做得好不一定夸你，做不好会强烈不满。例：登录稳定、数据不丢、支付成功后订单可查。基本型需求优先保证稳定性和完整性。",
          "期望型需求：满足程度越高，用户越满意，通常和核心体验或效率直接相关。例：搜索更准、加载更快、表单更少、推荐更贴合。期望型需求适合用数据指标持续优化。",
          "兴奋型需求：用户原本没预期，但出现后会惊喜，能形成差异化和传播。例：自动生成周报、智能填充 PRD、异常风险主动提醒。兴奋型需求要控制成本，用小实验验证。",
          "无差异型需求：做与不做对满意度影响都不大。常见于内部觉得“应该有”，但用户无感的装饰型功能。此类需求应谨慎投入。",
          "反向型需求：做了反而降低满意度。例：强制弹窗、复杂权限审批、过度自动化导致用户失去控制感。PM 要通过调研和灰度避免误伤。",
          "使用步骤：先收集需求，再通过用户访谈或问卷判断需求类型；然后结合业务价值、用户影响、技术成本排序；最后把不同类型写进路线图：基本型保底，期望型优化，兴奋型试验。",
          "KANO 不适合单独决定优先级。它应和 RICE、成本评估、战略目标一起使用：KANO 判断满意度影响，RICE 判断覆盖面和投入产出，路线图判断阶段节奏。"
        ],
        "cases": [
          "案例：做一个学习网站时，“文章能正常打开、进度能保存、移动端可读”属于基本型；“搜索更准、学习路径更清晰、知识点能联动图谱”属于期望型；“根据学习行为自动提醒复盘、生成个性化学习建议”属于兴奋型。",
          "案例：如果用户反馈“知识点内容太少”，这通常是基本型或期望型问题。知识库的基本要求是完整准确；进一步的期望型优化是结构统一、案例充足、能跳转到相关术语和图谱。"
        ],
        "pmApplication": [
          "需求评审时，PM 可以给每个需求标注 KANO 类型：基本型必须兜底，不应被砍；期望型看 ROI 排优先级；兴奋型先做低成本验证，不要一开始就重投入。",
          "写 PRD 时，把 KANO 结论转成验收标准：基本型写稳定性和异常流；期望型写效率或满意度指标；兴奋型写实验目标、灰度范围和复盘指标。",
          "面试回答时，可以用“分类—排序—验证”的逻辑说明：我先判断需求类型，再结合数据和成本排序，最后用灰度或 A/B 测试验证是否真的提升满意度。"
        ],
      ...
      },
      {
        ...
        "content": [
          "用最小成本验证核心假设的产品版本",
          "一句话定义：MVP 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“MVP”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "先做\"刚好能验证市场\"的版本，不要一开始就做\"大而全\"",
          "PM 记忆法：回答 MVP 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 核心模型（PM 必会）",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          "产品真正满足市场需求，能留住用户",
          "一句话定义：PMF 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“PMF”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "MVP → PMF 是创业产品必经之路，PMF 没找到之前不要盲目扩张",
          "PM 记忆法：回答 PMF 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 核心模型（PM 必会）",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：UCD 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“UCD”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "先访谈真实用户（不是脑补\"用户需要什么\"），用原型验证再迭代",
          "对比：\"老板说要加什么功能\"或\"竞品有什么我们也要有\"是反 UCD",
          "PM 记忆法：回答 UCD 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 核心模型（PM 必会）",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：JTBD 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“JTBD”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "用户买的不是\"产品\"，是\"完成任务的能力\"——理解任务比理解功能更重要",
          "PM 记忆法：回答 JTBD 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 核心模型（PM 必会）",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：OKR vs KPI 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“OKR vs KPI”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "OKR 定方向（季度），KPI 盯执行（周/月）",
          "PM 记忆法：回答 OKR vs KPI 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 核心模型（PM 必会）",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "解决时长：4 小时内",
          "故障恢复时长：1 小时内",
          "一句话定义：SLA 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“SLA”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "未达成通常按合同赔偿（扣款、延服务期）；SLA 指标要拆到架构和监控上",
          "PM 记忆法：回答 SLA 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 核心模型（PM 必会）",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：需求来源 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“需求来源”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 需求来源 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "2. 需求分析",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "技术成本：开发难度和资源",
          "ROI：投入产出比",
          "一句话定义：需求评估维度 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“需求评估维度”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 需求评估维度 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "2. 需求分析",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          "任务流程 / 操作反馈 / 异常处理",
          "一句话定义：交互设计 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“交互设计”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 交互设计 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "4. 产品设计",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "6. 原型/设计稿",
          "7. 验收标准",
          "一句话定义：PRD 结构 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“PRD 结构”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 PRD 结构 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "4. 产品设计",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：核心指标 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“核心指标”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 核心指标 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "5. 数据分析",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：三层核心文档 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“三层核心文档”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 三层核心文档 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：两类辅助文档 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“两类辅助文档”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 两类辅助文档 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "6. 文档体系（3 层 + 2 类）",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "技术实现细节：FSD（接口 + 数据结构）",
          "业务方验收：UAT（用例 + 通过标准）",
          "一句话定义：文档选择时机 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“文档选择时机”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 文档选择时机 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "6. 文档体系（3 层 + 2 类）",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "9. 上线发布",
          "10. 效果复盘",
          "一句话定义：需求评审 10 步 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“需求评审 10 步”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 需求评审 10 步 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "7. 项目管理",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：敏捷开发 4 个会议 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“敏捷开发 4 个会议”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 敏捷开发 4 个会议 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "7. 项目管理",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "提前对齐预期",
          "及时同步进展",
          "一句话定义：跨部门沟通 4 原则 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“跨部门沟通 4 原则”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 跨部门沟通 4 原则 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "8. 沟通协作",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "怎么做（方案）",
          "做成什么样（验收标准）",
          "一句话定义：需求宣讲 4 段式 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“需求宣讲 4 段式”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 需求宣讲 4 段式 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "8. 沟通协作",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：冒烟测试 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“冒烟测试”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 冒烟测试 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "9. 测试与质量保障",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：4 个关键边界 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“4 个关键边界”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 4 个关键边界 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "9. 测试与质量保障",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：相邻黑话对比 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“相邻黑话对比”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 相邻黑话对比 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "9. 测试与质量保障",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：提测日标准流程 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“提测日标准流程”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 提测日标准流程 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "9. 测试与质量保障",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：容易踩的坑 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“容易踩的坑”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 容易踩的坑 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "9. 测试与质量保障",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：记忆口诀 是 产品经理面试与基础方法 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“记忆口诀”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 记忆口诀 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "9. 测试与质量保障",
        "sourceId": "pm-bagu",
        "sourceLabel": "产品经理八股",
      ...
      },
      {
        ...
        "content": [
          ...
          "风险：最大不确定性和验证方式。",
          "一句话定义：Roadmap 版本规划 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“Roadmap 版本规划”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "写 Roadmap 时先把目标说清楚，再排功能。不要把所有需求塞进 V1；能验证核心假设的最小闭环才是第一版。",
          "PM 记忆法：回答 Roadmap 版本规划 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：B 端 vs C 端产品差异 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“B 端 vs C 端产品差异”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "面试被问 B/C 差异时，不要只说“B 端复杂、C 端体验好”。要从用户/客户、流程、指标、交付、权限五个维度展开。",
          "PM 记忆法：回答 B 端 vs C 端产品差异 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "sourceId": "career-playbook",
        "sourceLabel": "求职与作品集专题",
        "kind": "article"
      },
      {
        ...
        "content": [
          ...
          "一句话定义：AI 产品专题 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“AI 产品专题”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "做 AI 产品方案时，必须写清楚“AI 负责什么、人负责什么、失败怎么处理、效果怎么验收”。这比单纯列模型能力更重要。",
          "PM 记忆法：回答 AI 产品专题 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "sourceId": "career-playbook",
        "sourceLabel": "求职与作品集专题",
        "kind": "article"
      },
      {
        ...
        "content": [
          ...
          "一句话定义：STAR 法则 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“STAR 法则”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "准备 3 个 STAR 故事：一次用户洞察、一次跨团队推动、一次失败复盘。每个故事控制在 2 分钟内。",
          "PM 记忆法：回答 STAR 法则 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "sourceId": "career-playbook",
        "sourceLabel": "求职与作品集专题",
        "kind": "article"
      },
      {
        ...
        "content": [
          ...
          "一句话定义：竞品分析 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“竞品分析”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "面试里讲竞品分析，重点是“从现象推出判断”。比如竞品把模板放在首屏，说明其增长抓手可能是降低新用户冷启动成本。",
          "PM 记忆法：回答 竞品分析 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "sourceId": "career-playbook",
        "sourceLabel": "求职与作品集专题",
        "kind": "article"
      },
      {
        ...
        "content": [
          ...
          "做计算：保持数量级清晰，不陷入复杂小数。",
          "校验结果：用另一种方式粗略反推。",
          "一句话定义：估算题 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“估算题”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "估算题回答时要边说边写结构。面试官更关心你如何拆，而不是最后数字是否完全准确。",
          "PM 记忆法：回答 估算题 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "sourceId": "career-playbook",
        "sourceLabel": "求职与作品集专题",
        "kind": "article"
      },
      {
        ...
        "content": [
          ...
          "一句话定义：为什么想做 PM 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“为什么想做 PM”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "不要回答“我喜欢互联网”或“产品经理很有发展”。要用具体经历证明你已经接触过类似 PM 的问题。",
          "PM 记忆法：回答 为什么想做 PM 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "sourceId": "career-playbook",
        "sourceLabel": "求职与作品集专题",
        "kind": "article"
      },
      {
        ...
        "content": [
          ...
          "商业与增长：它如何获客、留存或变现。",
          "改进建议：提出一个小而具体的优化点。",
          "一句话定义：介绍一个喜欢的产品 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“介绍一个喜欢的产品”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "提前准备 2 个产品案例：一个 ToC、一个 ToB/工具。每个案例控制在 3 分钟，最后必须有自己的判断。",
          "PM 记忆法：回答 介绍一个喜欢的产品 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "sourceId": "career-playbook",
        "sourceLabel": "求职与作品集专题",
        "kind": "article"
      },
      {
        ...
        "content": [
          ...
          "做可点击路径：至少覆盖主流程和关键异常。",
          "收集反馈：让真实用户或同学按任务走一遍。",
          "一句话定义：原型设计 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“原型设计”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PRD 评审时，原型要配合业务规则和验收标准；否则研发只能看到页面，无法理解边界。",
          "PM 记忆法：回答 原型设计 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "sourceId": "career-playbook",
        "sourceLabel": "求职与作品集专题",
        "kind": "article"
      },
      {
        ...
        "content": [
          ...
          "一句话定义：核心指标设计 是 求职与作品集 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“核心指标设计”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "需求上线前就要想清楚验收指标。没有指标的需求，复盘时很难判断到底有没有价值。",
          "PM 记忆法：回答 核心指标设计 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "sourceId": "career-playbook",
        "sourceLabel": "求职与作品集专题",
        "kind": "article"
    ...
    "items": [
      {
        ...
        "content": [
          ...
          "一句话定义：三层架构 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“三层架构”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "写需求时明确\"动哪几层\"。例：\"工单页加深色模式\" = 只动表现层（前端 CSS）；\"接企学宝同步培训记录\" = 动业务层 + 数据层（要新加同步服务、新加表）。分层意识能让 PM 评估\"这个需求改 1 天还是 1 个月\"。",
          "PM 记忆法：回答 三层架构 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：单体架构 vs 微服务架构 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“单体架构 vs 微服务架构”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "不要在单体阶段硬上微服务——成本高、收益小。触发微服务化的 3 个信号：① 单次部署超过 30 分钟 ② 一个团队改动影响另一个团队的发布 ③ 不同模块的资源消耗差 10 倍以上。",
          "PM 记忆法：回答 单体架构 vs 微服务架构 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 架构基础（PM 必须懂的核心概念）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：前后端分离 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“前后端分离”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 前后端分离 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "1. 架构基础（PM 必须懂的核心概念）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：数据库 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“数据库”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "写需求必问\"数据存在哪\"——涉及\"数据搬家\"的需求（接企学宝、接 CRM）一定涉及数据层改造。",
          "PM 记忆法：回答 数据库 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：中间件 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“中间件”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 中间件 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "2. 关键组件（PM 经常听研发提到的\"零件\"）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：缓存策略 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“缓存策略”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 缓存策略 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "2. 关键组件（PM 经常听研发提到的\"零件\"）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：多租户架构 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“多租户架构”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 多租户架构 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：读写分离 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“读写分离”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 读写分离 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "3. 架构模式（成熟方案，直接套）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：分库分表 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“分库分表”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 分库分表 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "3. 架构模式（成熟方案，直接套）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：3 大经典问题 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“3 大经典问题”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "写非功能需求时，\"能扛多少 QPS/多少用户\" 一定要明确——研发不会主动告诉你系统能扛什么。",
          "PM 记忆法：回答 3 大经典问题 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：限流 / 降级 / 熔断 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“限流 / 降级 / 熔断”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 限流 / 降级 / 熔断 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "4. 高可用与高并发（PM 必懂的\"系统健壮性\"）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：监控告警 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“监控告警”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "上线后必问\"监控接好了吗\"——没监控就是\"盲飞\"。",
          "PM 记忆法：回答 监控告警 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "4. 高可用与高并发（PM 必懂的\"系统健壮性\"）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：认证 vs 授权 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“认证 vs 授权”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 认证 vs 授权 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "DDoS：CDN、高防 IP、限流",
          "数据泄露：字段加密、脱敏、最小权限",
          "一句话定义：常见攻击与防御 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“常见攻击与防御”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "To B 系统的数据安全是\"必答题\"——尤其涉及客户档案、培训记录、订单数据。PRD 里要明确\"敏感字段加密\"、\"权限最小化\"、\"操作留痕\"。",
          "PM 记忆法：回答 常见攻击与防御 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "5. 安全架构（PM 容易忽略的\"红线\"）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：6. 云原生与运维 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“6. 云原生与运维”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "写非功能需求时——\"环境一致性\"（本地跑通 ≠ 测试环境跑通 ≠ 生产跑通）需要 CI/CD 保证；\"弹性伸缩\"是云原生的核心价值。",
          "PM 记忆法：回答 6. 云原生与运维 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：OTA 空中升级架构 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“OTA 空中升级架构”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 OTA 空中升级架构 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "7. 机器人/IoT 系统特有架构（[本公司]专属）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：机器人数据流 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“机器人数据流”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "\"机器人数据存储\"是个跨多存储的复杂架构——PM 提需求时要知道\"清洁报告里的地图图片从对象存储拉\"。",
          "PM 记忆法：回答 机器人数据流 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "7. 机器人/IoT 系统特有架构（[本公司]专属）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "[本公司]云：阶段 2-3（部分服务已拆）",
          "机器人本体：阶段 2（边缘端轻量化服务）",
          "一句话定义：系统演进的 5 个阶段 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“系统演进的 5 个阶段”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 系统演进的 5 个阶段 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "4. 线上事故频发（\"每周都有 P 级故障\"）",
          "一句话定义：技术债识别 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“技术债识别”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "当技术债信号出现时，主动提\"技术债偿还 Sprint\"——不然业务会越来越慢。",
          "PM 记忆法：回答 技术债识别 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "8. 架构演进路径（PM 视角的\"技术债\"认知）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：C4 模型 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“C4 模型”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 C4 模型 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          "[本公司]云（代理商平台）\n                              │\n        ┌─────────────────────┼─────────────────────┐\n        │                     │                     │\n    终端用户                内部用户              外部系统\n   (代理商)              (销售/客服)            (企学宝/CRM)\n        │                     │                     │\n        └───── 飞书 OAuth 登录 ─────────────────────┘\n                              │\n                         对象存储(OSS)\n                         数据库(MySQL)\n                         缓存(Redis)",
          "一句话定义：[本公司]云系统 Context 图 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“[本公司]云系统 Context 图”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 [本公司]云系统 Context 图 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "9. 架构图绘制（PM 必会的\"沟通工具\"）",
        "sourceId": "system-architecture",
        "sourceLabel": "系统架构",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：10. PM 必会的 10 个架构问题 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“10. PM 必会的 10 个架构问题”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 10. PM 必会的 10 个架构问题 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：11. 关联文件 / 推荐阅读 是 系统架构 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“11. 关联文件 / 推荐阅读”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 11. 关联文件 / 推荐阅读 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：SaaS 关键指标 是 行业与系统术语 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“SaaS 关键指标”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 SaaS 关键指标 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "第一部分：技术架构",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
      ...
      },
      {
        ...
        "content": [
          ...
          "数据导出：客户要能带走数据（防锁定）",
          "一句话定义：SaaS PM 特有设计点 是 行业与系统术语 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“SaaS PM 特有设计点”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 SaaS PM 特有设计点 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "第一部分：技术架构",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：多租户3 种模式 是 行业与系统术语 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“多租户3 种模式”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 多租户3 种模式 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "第一部分：技术架构",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "content": [
          "管理企业与客户关系的系统和方法",
          "一句话定义：CRM 是 行业与系统术语 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“CRM”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 CRM 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "第二部分：业务管理",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
      ...
      },
      {
        ...
        "content": [
          "机器人配件和维修备件管理",
          "一句话定义：SCM 是 行业与系统术语 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“SCM”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 SCM 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "第二部分：业务管理",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
      ...
      },
      {
        ...
        "content": [
          "流程审批、文档管理、协同办公",
          "[本公司]用飞书审批 + OA 调拨单",
          "一句话定义：OA 是 行业与系统术语 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "案例：如果团队讨论“OA”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 OA 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "第二部分：业务管理",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：IPD 是 行业与系统术语 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“IPD”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 IPD 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "第二部分：业务管理",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
      ...
      },
      {
        ...
        "content": [
          "企业内部相对独立的业务部门/利润中心",
          "一句话定义：BU 是 行业与系统术语 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          "\"这个需求需要协调多个 BU\"",
          "案例：如果团队讨论“BU”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 BU 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "第二部分：业务管理",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
      ...
      },
      {
        ...
        "content": [
          ...
          "一句话定义：服务请求类 是 行业与系统术语 中用于统一判断、沟通和落地的基础概念。学习时不要只背定义，要能说清它解决什么问题、适合什么场景、如何验证结果。",
          "使用场景：1. 需求讨论时用它帮助团队对齐问题；2. 方案评审时用它解释取舍依据；3. 上线复盘时用它检查结果是否符合预期；4. 面试表达时用它把经历讲成“问题—方法—动作—结果”的闭环。",
          "PM 应用步骤：先明确目标用户和业务目标，再判断该概念对应的关键变量；随后把变量拆成可执行动作、验收标准和数据指标；最后在上线后复盘：哪些假设成立，哪些需要继续验证。",
          "常见坑：不要把概念当口号；不要脱离用户场景套模板；不要只写功能清单而不写成功标准；不要在没有数据或用户反馈时直接下结论。"
        ],
        "cases": [
          ...
          "案例：如果团队讨论“服务请求类”相关需求，PM 可以先把背景、目标用户、当前痛点、期望指标写在一页纸上，再邀请研发、设计、运营分别补充约束条件，最后形成可排期的最小方案。"
        ],
        "pmApplication": [
          "PM 记忆法：回答 服务请求类 时按“四段式”说——定义是什么、为什么重要、怎么落地、如何衡量。这样既能用于面试，也能直接迁移到日常 PRD 和评审沟通。"
        ],
        "section": "第二部分：业务管理",
        "sourceId": "industry-terms",
        "sourceLabel": "行业通用词语",
