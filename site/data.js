...
const categories = [
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "title": "1.1 北极星指标（North Star Metric）",
        "summary": "补全自:产品经理八股.md 5. 数据分析",
        "tags": [
          "产品策划方法论"
        ],
        "content": [
          ...
          "好北极星的 3 个特征:",
          "用户从产品获得核心价值时它会拉高 —— 反映\"用户真的从中获益\"",
          "业务增长时它会拉高 —— 反映\"业务真在增长\",不是自嗨",
          "团队任何人能解释\"我做的事怎么影响它\" —— 不是高管的 KPI,是一线员工也能用的\"指南针\"",
      ...
      },
      {
        ...
        "title": "1.2 商业模式画布（BMC, Business Model Canvas）",
        "summary": "补全自:产品经理八股.md 1. 核心模型",
        "tags": [
          "产品策划方法论",
          "BMC"
        ],
      ...
      },
      {
        ...
        "title": "1.3 价值主张画布（VPC, Value Proposition Canvas）",
        "summary": "补全自:产品经理八股.md 1. 核心模型",
        "tags": [
          "产品策划方法论",
          "VPC"
      ...
      },
      {
        ...
        "title": "1.4 OKR（Objectives & Key Results）",
      ...
      },
      {
        ...
        "title": "2.3 用户旅程地图（User Journey Map）",
      ...
      },
      {
        ...
        "title": "2.4 可用性测试（Usability Testing）",
        ...
        "content": [
          ...
          "A/B 远程异步:大流量产品的灰度验证",
          "3 步流程:",
          "写 3-5 个\"用户可能卡住\"的任务(如\"请找'你上个月看的培训视频'\")",
          "找 3-5 个不是同事的真实用户(同事太熟会给好评)",
          "看他们\"卡在哪、问什么、表情如何\",改完再上线"
        ],
        "cases": [
          "V17 升级功能上线前可用性测试"
        ],
      ...
      },
      {
        ...
        "content": [
          ...
          "5 步结构:",
          "暖场（5 分钟）:聊点轻松的,建立信任",
          "行为回顾（10 分钟）:\"上次遇到 XX 问题,你做了什么？\"",
          "痛点深挖（15 分钟）:\"那时候最难的是什么？\"",
          "方案探索（10 分钟）:\"如果有办法,理想是什么样的？\"",
          "总结确认（5 分钟）:\"我理解你刚才说的是...对吗？\"",
          "3 个不要:",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "title": "4.2 信息架构（Information Architecture, IA）",
        ...
        "content": [
          ...
          "画 IA 的 3 步法:",
          "拿张纸把所有功能/内容画成方块",
          "按\"用户找东西的心智路径\"重排(不是按你的开发目录)",
          "找 3 个真实用户跑\"找任务测试\",看他们点哪、卡哪"
        ],
        "cases": [
          "代理商平台 IA 改造效果"
        ],
      ...
      },
      {
        ...
        "title": "4.4 PRD 评审 Checklist（7 维自检）",
        "summary": "补全自:产品经理八股.md 7. 项目管理",
        "tags": [
          "产品策划方法论",
          "PRD"
        ],
      ...
      },
      {
        ...
        "title": "4.5 上线 Checklist",
        "summary": "补全自:工作流程.md 待补充",
        "tags": [
          "产品策划方法论"
        ],
        "content": [
      ...
      },
      {
        ...
        "title": "5.6 增长飞轮（Growth Flywheel）",
      ...
      },
      {
        ...
        "title": "6.2 鱼骨图（Ishikawa Diagram）",
        "summary": "来源:daily-log 6/26",
        "tags": [
          "产品策划方法论"
        ],
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "title": "1.4 多租户（Multi-Tenancy）3 种模式",
