    ...
    },
    {
      ...
      phases: [
        ...
        },
        {
          ...
          tasks: [
            { text: '学习用户研究：访谈技巧、用户画像、痛点清单', link: { href: '#/article/methodology/kb-product-methodology-2-5-\u7528\u6237\u8bbf\u8c08', label: '用户研究' } },
            { text: '学习需求分析：真伪需求、KANO、RICE 优先级', link: { href: '#/article/workflow/kb-workflow-2-\u9700\u6c42\u5206\u6790', label: '需求分析' } },
            { text: '学习 MVP 与迭代：Build-Measure-Learn', link: { href: '#/article/methodology/kb-pm-bagu-mvp', label: 'MVP' } },
        ...
        },
        {
          ...
          tasks: [
            { text: '学习 PRD 结构与写作要点', link: { href: '#/article/methodology/kb-product-methodology-4-3-prd-\u6807\u51c6-7-\u7ae0\u8282', label: 'PRD' } },
            { text: '学习原型设计：线框图 → 可点击 Demo', link: { href: '#/article/methodology/kb-career-playbook-\u539f\u578b\u8bbe\u8ba1', label: '原型' } },
            { text: '学习 Roadmap 与版本规划', link: { href: '#/article/methodology/kb-career-playbook-roadmap-\u7248\u672c\u89c4\u5212', label: 'Roadmap' } },
        ...
        },
        {
          ...
          goal: '从「做功能」升级到「懂业务」',
          tasks: [
            { text: '学习 B 端 vs C 端产品差异', link: { href: '#/article/methodology/kb-career-playbook-b-\u7aef-vs-c-\u7aef\u4ea7\u54c1\u5dee\u5f02', label: 'B/C 差异' } },
            { text: '了解商业模式画布与常见变现方式', link: { href: '#/article/methodology/kb-product-methodology-1-2-\u5546\u4e1a\u6a21\u5f0f\u753b\u5e03\u8865\u5168\u9879-2', label: '商业模式' } },
            { text: '学习核心指标设计（北极星、漏斗）', link: { href: '#/article/methodology/kb-career-playbook-\u6838\u5fc3\u6307\u6807\u8bbe\u8ba1', label: '指标设计' } },
            { text: '若倾向 AI 方向，阅读 AI 产品专题', link: { href: '#/article/methodology/kb-career-playbook-ai-\u4ea7\u54c1\u4e13\u9898', label: 'AI 产品' } },
        ...
        },
        {
          ...
          goal: '把知识转化为面试可用的表达',
          tasks: [
            { text: '掌握 STAR 法则，准备 3 个行为面试故事', link: { href: '#/article/methodology/kb-career-playbook-star-\u6cd5\u5219', label: 'STAR' } },
            { text: '练习竞品分析框架与表达', link: { href: '#/article/methodology/kb-career-playbook-\u7ade\u54c1\u5206\u6790', label: '竞品分析' } },
            { text: '了解估算题（DAU/市场规模）思路', link: { href: '#/article/methodology/kb-career-playbook-\u4f30\u7b97\u9898', label: '估算题' } },
            { text: '准备「介绍一个你喜欢的产品」类问题', link: { href: '#/article/methodology/kb-career-playbook-\u4ecb\u7ecd\u4e00\u4e2a\u559c\u6b22\u7684\u4ea7\u54c1', label: '参考' } },
      ...
      phases: [
        ...
        },
        {
          ...
          tasks: [
            ...
            { text: '完成用户调研（至少 5 人访谈或问卷）', link: { href: '#/article/methodology/kb-product-methodology-2-5-\u7528\u6237\u8bbf\u8c08', label: '用户研究' } },
            { text: '输出 PRD + 原型', link: { href: '#/article/methodology/kb-product-methodology-4-3-prd-\u6807\u51c6-7-\u7ae0\u8282', label: 'PRD' } },
          ],
        ...
        },
        {
          ...
          goal: '把作品转化为简历亮点',
          tasks: [
            { text: '用 STAR 改写项目经历（即使无正式实习）', link: { href: '#/article/methodology/kb-career-playbook-star-\u6cd5\u5219', label: 'STAR' } },
      ...
      phases: [
        ...
        },
        {
          ...
          tasks: [
            ...
            { text: '学习 PRD 与需求评审流程', link: { href: '#/article/methodology/kb-product-methodology-4-3-prd-\u6807\u51c6-7-\u7ae0\u8282', label: 'PRD' } },
        ...
        },
        {
          ...
          goal: '打造转行作品集与面试故事',
          tasks: [
            { text: '将旧经验改写成 STAR 产品故事', link: { href: '#/article/methodology/kb-career-playbook-star-\u6cd5\u5219', label: 'STAR' } },
