  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        {
          id: 'path-overview',
          title: '新人学习路径总览（6-8 周）',
          summary: '认知 → 方法论 → 技能 → 行业视野 → 求职准备 → 沉淀复盘',
          tags: ['路径', '规划'],
          content: [
            '本路径面向零基础或转行新人，假设每周投入 10-15 小时。可根据自身节奏压缩或拉长，但建议按阶段顺序推进，不要跳过「认知」直接背面试题。',
            '阶段一（第 1-2 周）：建立岗位认知，搞懂 PM 与周边角色的区别，选定大致方向（ToC/ToB/AI 等）。',
            '阶段二（第 3-4 周）：掌握核心方法论——用户研究、需求分析、MVP 思维，能讲清楚「为什么做」。',
            '阶段三（第 5 周）：修炼产出能力——PRD、原型、Roadmap，用工具把想法落地成文档与 Demo。',
            '阶段四（第 6 周）：拓展行业视野——B/C 端差异、商业模式、数据指标，建立宏观产品观。',
            '阶段五（第 7 周）：求职冲刺——STAR 法则、竞品分析、估算题，整理可讲述的项目故事。',
            '阶段六（第 8 周）：沉淀与迭代——复盘、论坛交流、查漏补缺，形成个人知识库。',
            '查看完整周计划与任务清单：从首页「学习路径推荐」进入，或在行业认知顶部选择具体路径（通用新人 / 求职冲刺 / 在校实习 / 转行过渡）。',
          ],
        },
      ],
    },
