  ...
  const categories = [
    {
      ...
      icon: '◇',
      tools: [
        { name: 'Figma', desc: '业界主流 UI/原型协作工具，免费版够用', url: 'https://www.figma.com', learn: 'https://www.figma.com/community/learn' },
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'Notion', desc: '灵活的知识库与项目管理，适合个人与小团队', url: 'https://www.notion.so', learn: 'https://www.notion.so/help' },
        { name: '语雀', desc: '阿里系知识库，结构清晰，适合团队文档', url: 'https://www.yuque.com', learn: 'https://www.yuque.com/help' },
        { name: 'Confluence', desc: '海外企业常用 Wiki，与 Jira 配套', url: 'https://www.atlassian.com/software/confluence', learn: 'https://www.atlassian.com/software/confluence/guides' },
      ],
    },
    {
      id: 'data',
      ...
      icon: '◆',
      tools: [
        { name: 'Google Analytics', desc: '网站/应用流量分析国际标准', url: 'https://analytics.google.com', learn: 'https://support.google.com/analytics' },
        ...
        { name: 'Excel / Google 表格', desc: '基础数据处理必备，透视表与图表', url: 'https://sheets.google.com', learn: 'https://support.google.com/docs/topic/9054603' },
      ],
    },
    {
      id: 'project',
      ...
      icon: '▣',
      tools: [
        { name: 'Jira', desc: '海外研发管理标准，Scrum/Kanban', url: 'https://www.atlassian.com/software/jira', learn: 'https://www.atlassian.com/software/jira/guides' },
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'UserTesting', desc: '海外远程可用性测试平台', url: 'https://www.usertesting.com', learn: 'https://www.usertesting.com/resources' },
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'draw.io', desc: '免费开源图表工具（现 diagrams.net）', url: 'https://www.diagrams.net', learn: 'https://www.diagrams.net/doc/' },
        { name: 'XMind', desc: '思维导图经典工具，适合拆解问题', url: 'https://xmind.cn', learn: 'https://xmind.cn/user-guide/' },
        { name: 'Whimsical', desc: '流程图+线框图，风格简洁', url: 'https://whimsical.com', learn: 'https://docs.whimsical.com' },
      ],
    },
    {
      id: 'ai',
      ...
      icon: '✦',
      tools: [
        { name: 'ChatGPT', desc: '通用对话与写作辅助，适合头脑风暴', url: 'https://chat.openai.com', learn: 'https://help.openai.com' },
        { name: 'Cursor', desc: 'AI 编程与产品原型探索（本站在用）', url: 'https://cursor.com', learn: 'https://docs.cursor.com' },
        { name: 'Kimi / 通义', desc: '国内长文档阅读与总结', url: 'https://kimi.moonshot.cn', learn: 'https://kimi.moonshot.cn' },
        { name: 'Midjourney', desc: 'AI 出图，适合概念视觉探索', url: 'https://www.midjourney.com', learn: 'https://docs.midjourney.com' },
      ],
    },
    {
      id: 'presentation',
      ...
      tools: [
        ...
        { name: 'Gamma', desc: 'AI 生成演示文稿', url: 'https://gamma.app', learn: 'https://help.gamma.app' },
